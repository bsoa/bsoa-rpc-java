/**
 *  BeanUtils.java Created on 2014/8/14 17:28
 *
        ...
        for (Method method : methods) {
            ...
            if (ReflectUtils.isBeanPropertyReadMethod(method)) {
                ...
                try {
                    ...
                    throw new BsoaRuntimeException(22000, "Can't access copy " + propertyName, e.getCause());
                } catch (IllegalAccessException e) {
                    throw new BsoaRuntimeException(22000, "Can't access copy " + propertyName, e);
                }
